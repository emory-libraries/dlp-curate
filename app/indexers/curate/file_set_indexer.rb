  ...
  class FileSetIndexer < Hyrax::FileSetIndexer
    def generate_solr_document
      super.tap do |solr_doc|
        ...
        if object.pulled_preservation_master_file.present?
          solr_doc['file_name_ssim'] = object.pulled_preservation_master_file.file_name
          solr_doc['file_size_ssim'] = object.pulled_preservation_master_file.file_size
          solr_doc['date_created_ssim'] = object.pulled_preservation_master_file.date_created
          solr_doc['valid_ssim'] = object.pulled_preservation_master_file.valid
          solr_doc['well_formed_ssim'] = object.pulled_preservation_master_file.well_formed
          solr_doc['character_set_ssim'] = object.pulled_preservation_master_file.character_set
          solr_doc['byte_order_ssim'] = object.pulled_preservation_master_file.byte_order
          solr_doc['color_space_ssim'] = object.pulled_preservation_master_file.color_space
          solr_doc['compression_ssim'] = object.pulled_preservation_master_file.compression
          solr_doc['profile_name_ssim'] = object.pulled_preservation_master_file.profile_name
          solr_doc['profile_version_ssim'] = object.pulled_preservation_master_file.profile_version
        end
        add_sha1(solr_doc)
