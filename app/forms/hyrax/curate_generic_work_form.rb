...
module Hyrax
  ...
  class CurateGenericWorkForm < Hyrax::Forms::WorkForm
    ...
    self.terms = [:title, :institution, :holding_repository, :administrative_unit,
                  :sublocation, :access_right, :content_type, :content_genres, :abstract,
                  :table_of_contents, :edition, :alt_title, :rights_notes, :primary_language,
                  :subject_topics, :subject_names, :subject_geo, :subject_time_periods,
                  :conference_name, :uniform_title, :series_title, :parent_title,
                  :contact_information, :publisher_version, :creator, :contributors,
                  :sponsor, :data_producers, :grant_agencies, :grant_information,
                  :author_notes, :notes, :data_source_notes, :geographic_unit, :technical_note,
                  :issn, :isbn, :related_publications, :related_datasets, :extent,
                  :publisher, :date_created, :date_issued, :conference_dates, :data_collection_dates,
                  :local_call_number, :related_material_notes, :final_published_versions,
                  :issue, :page_range_start, :page_range_end, :volume, :place_of_production,
                  :keywords, :emory_rights_statements, :rights_statement, :rights_holders,
                  :copyright_date, :re_use_license, :access_restriction_notes, :rights_documentation,
                  :scheduled_rights_review, :scheduled_rights_review_note, :internal_rights_note,
                  :legacy_rights, :data_classifications, :sensitive_material, :sensitive_material_note,
                  :staff_notes, :date_digitized, :transfer_engineer, :other_identifiers,
                  :emory_ark, :system_of_record_ID, :primary_repository_ID, :deduplication_key,
    ...
    def self.build_permitted_params
      permitted = super
      permitted += [:representative_id, :thumbnail_id, :admin_set_id, :visibility_during_embargo,
                    :embargo_release_date, :visibility_after_embargo, :visibility_during_lease,
                    :lease_expiration_date, :visibility_after_lease, :visibility,
                    { ordered_member_ids: [] }, { rendering_ids: [] }]
      permitted << {
        preservation_workflow_attributes: [
          :id,
          { workflow_type: [] },
