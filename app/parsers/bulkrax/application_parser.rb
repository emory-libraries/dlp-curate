...
module Bulkrax
  ...
  class ApplicationParser
    ...
    def visibility
      @visibility ||= parser_fields['visibility'] || 'open'
    end
    ...
    def invalid_record(message)
      ...
      ImporterRun.decrement_counter(:enqueued_records, current_run.id) unless ImporterRun.find(current_run.id).enqueued_records <= 0
    end
