...
module Bulkrax
  module DatatablesBehavior
    ...
    def entry_util_links(e, item)
      ...
      links << view_context.link_to(
        view_context.raw('<span class="fa fa-trash"></span>'),
        view_context.item_entry_path(item, e),
        method: :delete,
        data:   { confirm: 'This will delete the entry and any work associated with it. Are you sure?' }
      )
      links.join(" ")
    end
