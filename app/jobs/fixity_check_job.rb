...
class FixityCheckJob < Hyrax::ApplicationJob
  ...
  private
    ...
    def run_check(file_set_id, file_id, uri, initiating_user)
      ...
      log = ChecksumAuditLog.create_and_prune!(passed: service.check, file_set_id: file_set_id, checked_uri: uri.to_s, file_id: file_id, expected_result: expected_result)
