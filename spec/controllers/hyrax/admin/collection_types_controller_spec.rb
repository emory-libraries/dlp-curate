...
# [Hyrax-overwrite-v3.0.0.pre.rc1] The only thing altered in this controller is
# the allowed params.
RSpec.describe Hyrax::Admin::CollectionTypesController, type: :controller, clean_repo: true do
  ...
  context "authorized user" do
    ...
    describe "#update", :clean_repo do
      ...
      context "with invalid params" do
        let(:existing_collection_type) { FactoryBot.create(:collection_type) }
    ...
    describe "#destroy" do
      let!(:collection_type_to_destroy) { FactoryBot.create(:collection_type) }
      ...
      context "when collections exist of this type" do
        let!(:collection) { FactoryBot.create(:collection_lw, collection_type_gid: collection_type_to_destroy.gid) }
