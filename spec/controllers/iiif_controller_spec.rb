...
RSpec.describe IiifController, type: :controller do
  ...
  context 'a request without the IIIF_SERVER_URL set' do
    before do
  ...
  context "visibility settings control who can see what" do
    before do
    ...
    context "public / open documents" do
      let(:identifier) { "7e7c52437c41c0ec1982e39d93a7a32db1ed1ba7" }
      let(:document) do
        {
          id:                      '222333',
      ...
      context "a request for info.json" do
        let(:params) do
          {
            identifier: identifier,
            info:       "info",
      ...
      context "a request for a public image" do
    ...
    context "a request for a Public Low View object" do
      let(:identifier) { "7e7c52437c41c0ec1982e39d93a7a32db1ed1ba7" }
      let(:document) do
        {
          id:                      '222333',
      ...
      let(:altered_iiif_url) { "http://127.0.0.1:8182/iiif/2/#{identifier}/full/400,/0/default.jpg" }

      it "alters the iiif request to ensure a max resolution" do
        stub_request(:any, altered_iiif_url).to_return(
          body:    "SUCCESS",
          status:  200,
          headers: { 'Content-Length' => 3 }
        )
        get :show, params: params
        expect(assigns(:iiif_url)).to eq altered_iiif_url
      end
