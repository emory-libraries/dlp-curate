...
RSpec.shared_examples 'a Valkyrie::Persister in Curate' do |*flags|
  before do
  ...
  it "stores created_at/updated_at" do
    ...
    # NOTE: The expectation below rarely ever works in Rails 6+. The dates are almost always exactly the same.
